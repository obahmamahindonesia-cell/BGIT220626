  ...
  return (
    <div className="h-full flex flex-col bg-white/[0.02]">
      <div className="px-4 py-3 border-b border-white/[0.06] flex-shrink-0">
        <h3 className="text-xs font-semibold text-white/60 uppercase tracking-wider">{t('testRunner.navTitle')}</h3>
        <div className="flex items-center gap-3 mt-2">
          <div className="flex items-center gap-1.5">
            <div className="w-2.5 h-2.5 rounded-full bg-[#10B981]" />
            <span className="text-[10px] text-white/30">{t('testRunner.answered', { n: answeredCount })}</span>
          </div>
          <div className="flex items-center gap-1.5">
            <div className="w-2.5 h-2.5 rounded-full bg-[#F59E0B]" />
            <span className="text-[10px] text-white/30">{t('testRunner.flaggedCount', { n: flaggedCount })}</span>
          </div>
          <div className="flex items-center gap-1.5">
            <div className="w-2.5 h-2.5 rounded-full bg-white/[0.08]" />
            <span className="text-[10px] text-white/30">{t('testRunner.remainingCount', { n: questions.length - answeredCount })}</span>
          </div>
        </div>
      </div>
      ...
      <div className="px-4 py-3 border-t border-white/[0.06] flex-shrink-0 space-y-2">
        ...
        >
          <span className="text-white/40">{t('testRunner.showFlagged')}</span>
