        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-muted-foreground text-sm leading-relaxed mb-6">
              Setiap peserta BIGT menerima sertifikat digital yang dapat diverifikasi secara publik 
              melalui QR code atau Certificate ID. Institusi dan pemberi kerja dapat memvalidasi 
              keaslian sertifikat kapan saja.
            </p>
          ...
          <div className="bg-gradient-to-br from-[#0B3D91] to-[#1a4a8a] rounded-2xl p-8 text-center">
            ...
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-lg px-4 py-2">
              ...
              <span className="text-white/50 text-xs">Scan untuk verifikasi</span>
            </div>
          </div>
        </div>
      </div>
