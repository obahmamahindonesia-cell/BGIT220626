...
const LEVELS = [
  {
    code: 'A1', name: 'Pemula', color: '#6B7280',
  ...
  {
    code: 'A2', name: 'Dasar', color: '#6B7280',
  ...
  {
    code: 'B1', name: 'Madya', color: '#378ADD',
  ...
  {
    code: 'B2', name: 'Madya Atas', color: '#378ADD',
  ...
  {
    code: 'C1', name: 'Mahir', color: '#E11D48',
  ...
  {
    code: 'C2', name: 'Sangat Mahir', color: '#D4AF37',
    ...
    <main>
      ...
      <section className="bg-gradient-to-br from-[#0B3D91] via-[#0B3D91] to-[#1e4a8f] text-white pt-28 pb-20 px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <h1 className="font-[family-name:var(--font-playfair)] text-4xl md:text-5xl font-bold leading-tight mb-6">
            Enam level, satu <span className="text-[#D4AF37]">standar global</span>
          </h1>
      ...
      <section className="py-8 px-6 bg-white border-b border-gray-100">
        <div className="max-w-4xl mx-auto">
          <div className="flex gap-2 flex-wrap justify-center">
            {LEVELS.map((level) => (
              <div key={level.code} className="flex-1 min-w-[80px] text-center p-4 rounded-2xl border border-gray-100 premium-shadow-md">
                <div className="text-lg font-bold font-[family-name:var(--font-playfair)]" style={{ color: level.color }}>
                  {level.code}
                </div>
      ...
      <section className="py-20 px-6 bg-[#F8FAFC]">
        <div className="max-w-4xl mx-auto space-y-6">
          {LEVELS.map((level) => (
            <div key={level.code} className="bg-white border border-gray-100 rounded-2xl p-6 md:p-8 premium-shadow-md card-hover">
              <div className="flex items-start gap-4 md:gap-6">
                <div className="w-16 h-16 md:w-20 md:h-20 rounded-2xl flex items-center justify-center shrink-0" style={{ backgroundColor: `${level.color}12` }}>
                  <span className="text-2xl md:text-3xl font-bold font-[family-name:var(--font-playfair)]" style={{ color: level.color }}>
                    {level.code}
                  </span>
                </div>
                <div className="flex-1">
                  <h2 className="text-lg md:text-xl font-semibold text-[#0B3D91] mb-1">{level.name}</h2>
