...
const PRODUCTS = [
  ...
  { name: 'BIGT Latihan', tag: 'Latihan', description: 'Simulasi tes BIGT untuk persiapan dan familiarisasi.', audience: 'Semua calon peserta BIGT', duration: '2 jam', useCases: ['Persiapan sebelum tes resmi', 'Familiarisasi dengan format dan tipe soal', 'Identifikasi area yang perlu ditingkatkan', 'Evaluasi mandiri secara berkala'], level: 'A1 — C2' },
]
