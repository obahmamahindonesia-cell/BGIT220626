...
const BLUEPRINT_CARDS: BlueprintCard[] = [
  {
    id: 'A1_LEVEL_EXAM',
    label: 'A1 Pemula',
    description: 'Menguji pemahaman dasar dalam situasi sehari-hari — Membaca, Mendengarkan, Menulis & Berbicara.',
    includes: ['Membaca', 'Menyimak', 'Menulis', 'Berbicara'],
    duration: '±60 menit',
    totalItems: 80,
    disabled: false,
    color: '#0B1F3A',
  },
  {
    id: 'A2_LEVEL_EXAM',
    label: 'A2 Dasar',
    description: 'Menguji pemahaman situasi sehari-hari, jadwal, layanan, dan percakapan pendek — Membaca, Mendengarkan, Menulis & Berbicara.',
    includes: ['Membaca', 'Menyimak', 'Menulis', 'Berbicara'],
    duration: '±65 menit',
    totalItems: 80,
    disabled: false,
  ...
  },
  {
    ...
    description: 'Menentukan level awal pengguna secara otomatis — Membaca, Mendengarkan, Menulis & Berbicara.',
    includes: ['Membaca', 'Menyimak', 'Menulis', 'Berbicara'],
    duration: '±60 menit',
    totalItems: 70,
    disabled: false,
